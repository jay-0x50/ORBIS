...
Shader "Orbis/World/TerrainToon"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "Queue" = "Geometry-100" "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "TerrainCompatible" = "True" "IgnoreProjector" = "False" }
        Pass
        {
            Name "ForwardLit"
    ...
    Dependency "AddPassShader" = "Hidden/Orbis/World/TerrainAdd"
    Dependency "BaseMapShader" = "Hidden/Orbis/World/TerrainBase"
